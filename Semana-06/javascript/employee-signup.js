window.onload = function () {
    ...
    signUpButton.addEventListener("click", BSignUpBlur);
    ...
    function BSignUpBlur() {
        if (!validateName(fname.value)) {
            alert(fname.value + " First name is incorrect ");
        } else if (!validateName(lname.value)) {
            alert(lname.value + " Last name is incorrect ");
        } else if (!validateDni()) {
            alert(dni.value + " DNI is incorrect ");
        } else if (!validateDoF()) {
            alert(dateofbirth.value + " Date of birth is incorrect");
        } else if (!validatePhone()) {
            alert(phone.value + " Number phone is incorrect");
        } else if (!validateaddress()) {
            alert(address.value + " Address is incorrect");
        } else if (!validateCity()) {
            alert(city.value + " City is incorrect");
        } else if (!validatePostCode()) {
            alert(postalCode.value + " ZIP is incorrect");
        } else if (!validateEmail()) {
            alert(email.value + " Email is incorrect");
        } else if (!validatePassword(password.value)) {
            alert(password.value + " Password is incorrect");
        } else if (!validatePassword(repeatPassword.value)) {
            alert(repeatPassword.value + " Repeat password is incorrect");
            ...
            alert(password.value + " Passwords not are the same"); 
                ...
                validateDni(dni.value) && validateDoF(dateofbirth.value) &&
                validatePhone(phone.value) && validateaddress(address.value) &&
                validateCity(city.value) && validatePostCode(postalCode.value) &&
